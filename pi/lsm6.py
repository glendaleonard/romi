...
class LSM6DS33:
    ...
    def read_current_gyro_degrees_x(self):
        ...
        self.current_gyro_degrees_x = self.current_gyro_degrees_x + (self.read_scaled_dps_gyro_x() * 0.1)
        return round(self.current_gyro_degrees_x, 4)

    def read_current_gyro_degrees_y(self):
        self.current_gyro_degrees_y = self.current_gyro_degrees_y + (self.read_scaled_dps_gyro_y() * 0.1)
        return round(self.current_gyro_degrees_y, 4)

    def read_current_gyro_degrees_z(self):
        self.current_gyro_degrees_z = self.current_gyro_degrees_z + (self.read_scaled_dps_gyro_z() * 0.1)
